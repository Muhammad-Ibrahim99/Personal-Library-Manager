...
def create_visualization(stats):
    ...
    if stats['genres']:
        ...
        fig_genres.update_layout(
            title_text = 'Book by puclication genres',
            xaxis_title = 'Genres',
    ...
    if stats['decades']:
        ...
        fig_decades.update_layout(
            title_text = 'Book by puclication decade',
            xaxis_title = 'Decade',
            yaxis_title = 'Number of books',
            height = 400
        )
...
# Footer
st.markdown("---")
st.markdown("© 2025 Muhammad Ibrahim Personal Library Manager | Created with ♥ and Streamlit", unsafe_allow_html=True)
